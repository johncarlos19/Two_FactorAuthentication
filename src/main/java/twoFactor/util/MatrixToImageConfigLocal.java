...
public final class MatrixToImageConfigLocal {
    /*
     ...
     */
         ...
         */
        public MatrixToImageConfigLocal() {
            this(BLACK, WHITE);
        }
         ...
         */
        public MatrixToImageConfigLocal(int onColor, int offColor) {
